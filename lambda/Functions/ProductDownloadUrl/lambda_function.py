...
# Removed explicit endpoint_url to allow Moto to intercept calls correctly during testing
...
def lambda_handler(event, context):
    try:
        ...
        product_id = (event or {}).get("pathParameters", {}).get("id")
        if not product_id:
        ...
        # 4. Return presigned URL inside the data payload
